let Items = [
  ...
  {
    hint: [
      "Active: Overwhelming Blink Teleport to a target point up to 1200 units away.After teleportation, all enemies in a 800 AoE have 50% movement speed slow and 50 attack speed slow for 6 seconds, and take damage equal to 200 + 100% of your strength. Overwhelming Blink cannot be used for 3 seconds after taking damage from an enemy hero or Roshan.",
    ],
    id: 600,
  ...
  {
    hint: [
      "Active: Swift Blink Teleport to a target point up to 1200 units away.After teleportation, you gain 40% phased movement speed, +50 Attack Speed, and +50 Attack Damage for 6 seconds. Swift Blink cannot be used for 3 seconds after taking damage from an enemy hero or Roshan.",
    ],
    id: 603,
    name: "swift_blink",
  ...
  {
    hint: [
      "Active: Arcane Blink Teleport to a target point up to 1200 units away.After teleportation, you gain 25% Ability Cooldown Reduction and 50% Cast Point reduction for 6 seconds. Arcane Blink cannot be used for 3 seconds after taking damage from an enemy hero or Roshan.",
    ],
    id: 604,
    name: "arcane_blink",
  ...
  },
  {
    ...
    cost: 4000,
    notes:
      "The bonus night vision works during Night Stalker's Darkness ability.",
    attrib: [
      {
  ...
  },
  {
    ...
    cd: false,
    lore:
      "A stately crown created to ensure a well-meaning but ungifted heir could fend off usurpers and govern with a strong hand.",
    components: null,
    created: false,
    charges: false,
  },
  ...
  {
    hint: [
      "Passive: Spell Lifesteal10% of spell damage dealt to enemy heroes is returned to the caster as health, regardless of spell damage type.  Lifesteal reduced to 2% against creeps.",
    ],
    id: 473,
    name: "voodoo_mask",
  ...
  },
  {
    ...
    cd: false,
    lore:
      "An ageless ring forged with an otherwise simple blood magic amplified by the presumed source of its key component.",
    components: null,
    created: false,
    charges: false,
  },
  ...
  },
  {
    ...
    cost: 1875,
    notes:
      "Restore does not affect units that have been affected by Restore in the last 25 seconds.\nMultiple instances of Mekansm Aura do not stack.",
    attrib: [
      {
        key: "bonus_armor",
        header: "+",
  ...
  },
  {
    hint: [
      ...
      "",
      "Passive: Regeneration AuraGrants 3 health regeneration to allies.Radius: 1200",
    ],
    id: 269,
    name: "holy_locket",
  ...
  },
  {
    ...
    components: ["sobi_mask", "circlet", "ring_of_protection"],
    created: true,
    charges: false,
  },
  {
  ...
  },
  {
    ...
    img:
      "/apps/dota2/images/items/ultimate_scepter_roshan_lg.png?t=1593393829403",
  ...
  {
    hint: ["Passive: Ability UpgradeUpgrades one of your abilities."],
    id: 609,
    name: "aghanims_shard",
  ...
  },
  {
    ...
    img:
      "/apps/dota2/images/items/aghanims_shard_roshan_lg.png?t=1593393829403",
  ...
  },
  {
    ...
    attrib: [
      ...
      {
        key: "hero_lifesteal",
        header: "+Spell Lifesteal (Hero)",
        value: "15%",
      },
      {
        key: "creep_lifesteal",
        header: "+Spell Lifesteal (Creep)",
        value: "3%",
      },
    ],
    mc: false,
    ...
    components: ["voodoo_mask", "kaya", "soul_booster"],
    created: true,
    charges: 14,
  },
  {
  ...
  },
  {
    ...
    attrib: [
      ...
      },
      {
        ...
        header: "+",
        value: "20%",
        footer: "Spell Lifesteal (Heroes)",
      },
      {
        key: "creep_lifesteal",
        header: "+",
        value: "4%",
        footer: "Spell Lifesteal (Creeps)",
      },
    ],
    mc: 50,
    cd: 60,
  ...
  },
  {
    ...
    components: ["invis_sword", "oblivion_staff"],
    created: true,
    charges: false,
  },
  {
  ...
  },
  {
    ...
    img:
      "/apps/dota2/images/items/helm_of_the_dominator_lg.png?t=1593393829403",
  ...
  {
    hint: [
      "Passive: Mage SlayerPlaces a debuff when you attack enemies, causing them to do 35% less spell damage for 4 seconds.",
    ],
    id: 598,
    name: "mage_slayer",
    ...
    components: ["cloak", "blade_of_alacrity", "claymore"],
    created: true,
    charges: false,
  },
  {
  ...
  },
  {
    ...
    cost: 0,
    notes:
      "Does not stack with armor auras from Ring of Basilius or Ring of Aquila.\nMultiple instances of Aquila Aura do not stack.",
    attrib: [
      {
        key: "bonus_damage",
        header: "+",
  ...
  },
  {
    ...
    cd: false,
    lore:
      "Stolen from a tinker's shop ages ago, this handy lens has seen service to many owners.",
    components: null,
    created: false,
    charges: false,
    tier: 1,
  },
  {
    ...
    cd: false,
    lore:
      "A gift from the moon goddess to one of her prized disciples many memories ago.",
    components: null,
    created: false,
    charges: false,
    tier: 2,
  ...
  {
    hint: [
      "Passive: Cooldown ReductionReduces the cooldown time of all spells and items by 12%",
    ],
    id: 289,
  ...
  },
  {
    ...
    cd: false,
    lore:
      "A weightless charm created by an enchanter with a powerful scorn for brute force.",
    components: null,
    created: false,
    charges: false,
    tier: 2,
  },
  {
    ...
    cd: 8,
    lore:
      "Elusive marvels never successfully studied for proper classification in the archives.",
    components: null,
    created: false,
    charges: false,
    tier: 5,
  },
  {
    ...
    cd: false,
    lore:
      "The original demonic favorite that served as basis for the beloved mortal design.",
    components: null,
    created: false,
    charges: false,
    tier: 5,
  ...
  },
  {
    ...
    cd: 60,
    lore:
      "The curious creation of a wizard who professed to hail from another time.",
    components: null,
    created: false,
    charges: false,
    tier: 5,
  ...
  },
  {
    ...
    cd: false,
    lore:
      "An unmarred discovery from the excavated ruins of an ancient wizard's academy.",
    components: null,
    created: false,
    charges: false,
    tier: 4,
  ...
  },
  {
    ...
    cd: false,
    lore:
      "To those who harvest olgru jelly, success serves more than mere profit--it's often the means to survival--for only the jelly itself can cure the ravages that follow a sting from the vigilant denizens of the giant hives.",
    components: null,
    created: false,
    charges: 2,
  },
  ...
  },
  {
    ...
    cd: 12,
    lore:
      "A bewitching blade of indeterminate form capable of piercing the psyche of even the most willful foe.",
    components: null,
    created: false,
    charges: false,
    tier: 3,
  ...
  {
    hint: [
      "Passive: Cooldown ReductionReduces the cooldown time of all spells and items by 18%.",
    ],
    id: 311,
    name: "spell_prism",
    ...
    cd: false,
    lore:
      "Even the slightest flaw in the components of a spell prism can result in the death of its user.",
    components: null,
    created: false,
    charges: false,
    tier: 4,
  ...
  },
  {
    ...
    cd: 7,
    lore:
      "Though their tasks are largely thankless, demon hunters can often turn a profit bartering parts in Weeping Rose.",
    components: null,
    created: false,
    charges: false,
    tier: 2,
  ...
  },
  {
    ...
    cd: false,
    lore:
      "The coveted treasure that divided the heirs of Queen Raiya upon her death, resulting in the eventual downfall of her kingdom.",
    components: null,
    created: false,
    charges: false,
    tier: 2,
  ...
  },
  {
    ...
    cd: false,
    lore:
      "The surprisingly dangerous creation of an apprentice sorcerer with a strange fondness for brooms.",
    components: null,
    created: false,
    charges: false,
    tier: 1,
  ...
  },
  {
    ...
    cd: false,
    lore:
      "The remains of a dragon always outvalue the wealth of even the most prodigious hoard.",
    components: null,
    created: false,
    charges: false,
    tier: 2,
  ...
  },
  {
    ...
    cd: 45,
    lore:
      "Valuable equipment recovered by a young explorer sifting through the flotsam and detritus drifting in the void.",
    components: null,
    created: false,
    charges: false,
    tier: 4,
  },
  {
    ...
    cd: 30,
    lore:
      "A dashing cape whose creator insists on calling 'Cloak of Apparition' as opposed to his assistant's 'Illusion' drivel.",
    components: null,
    created: false,
    charges: false,
    tier: 4,
  ...
  },
  {
    ...
    cd: 15,
    lore:
      "One of the few surviving creations of the acolytes of the Wyrmforge.",
  ...
  {
    hint: ["Active: Dig Channel for 1 second. Always finds a Bounty Rune!"],
    id: 372,
    name: "pirate_hat",
  ...
  },
  {
    ...
    cd: 25,
    lore:
      "The remains of an ancient universe, preserved within a single sphere.",
    components: null,
    created: false,
    charges: false,
    tier: 5,
  ...
  },
  {
    ...
    cd: false,
    lore:
      "The sigil blade of the legendary Brother Yhols of Gausra, stripped from its scabbard on the day of his controversial excommunication.",
    components: null,
    created: false,
    charges: false,
    tier: 3,
  },
  {
    ...
    cd: 40,
    lore:
      "The trophy from a mighty beast ambushed and slain in the recesses of its own home.",
    components: null,
    created: false,
    charges: false,
    tier: 4,
  ...
  },
  {
    ...
    cd: false,
    lore:
      "A demonic blade that struck the final blow to crack the gates of the Sanctum of Solanas.",
    components: null,
    created: false,
    charges: false,
    tier: 4,
  ...
  },
  {
    ...
    cd: false,
    lore:
      "Though many desire this brilliant shard for its obvious qualities, a school of study exists to determine the true size and purpose of its incomprehensible whole.",
    components: null,
    created: false,
    charges: false,
    tier: 3,
  ...
  },
  {
    ...
    cd: false,
    lore:
      "Even simple items of elven make seem imbued with inexplicable efficacy.",
    components: null,
    created: false,
    charges: false,
    tier: 3,
  ...
  {
    hint: [
      "PassiveBurns enemy units for 45 damage per second. Illusions deal 30 damage per second.Radius: 375",
    ],
    id: 574,
  ...
  },
  {
    ...
    cd: 25,
    lore:
      "A fantastic garment immediately misplaced by its creator upon completion.",
    components: null,
    created: false,
    charges: false,
    tier: 4,
  ...
  {
    hint: [
      "Passive: LifestealHeals the attacker for 7% of attack damage dealt.",
    ],
    id: 577,
    name: "possessed_mask",
    ...
    cd: false,
    lore:
      "Even when discarded with specific purpose and great care, this frightening mask always finds its way onto the face of a new owner.",
    components: null,
    created: false,
    charges: false,
    tier: 1,
  ...
  },
  {
    ...
    cd: false,
    lore:
      "The final, twisted work of a severely pious blacksmith, completed immediately before the taking of his own life. ",
    components: null,
    created: false,
    charges: false,
    tier: 4,
  ...
  },
  {
    ...
    cd: 20,
    lore:
      "A failed experiment in finer telekinetic control, still fit for other ends.",
    components: null,
    created: false,
    charges: false,
    tier: 3,
  },
  {
    ...
    cd: false,
    lore:
      "One of many items lost in the looting of Zelenwyr's sacred reliquary.",
    components: null,
    created: false,
    charges: false,
    tier: 3,
  ...
  },
  {
    ...
    cd: 8,
    lore:
      "An impossible tome filled with unreadable prose of unknowable thoughts.",
    components: null,
    created: false,
    charges: false,
    tier: 5,
  },
  {
    ...
    cd: false,
    lore:
      "Prized procurement of an otherwise unremarkable ruler of Elze who abdicated his position and vanished.",
    components: null,
    created: false,
    charges: false,
    tier: 5,
  ...
  },
  {
    hint: [
      ...
      "",
      "Passive Zaps an enemy within 700 range, dealing 200 damage and a 40% slow for 0.3 seconds. Strikes every 3 seconds.",
    ],
    id: 585,
    name: "stormcrafter",
    ...
    cd: 25,
    lore:
      "The accidental byproduct of a spell conjured to entrap a lesser god.",
    components: null,
    created: false,
    charges: false,
    tier: 4,
